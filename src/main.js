...
window.onload = () => {
  ...
  const initWeb3 = async () => {
    const setDataLogged = async () => {
      ...
      if (lblAlert) lblAlert.innerHTML = "";
      if (lblAmount) lblAmount.innerHTML = 250;
      if (lblUSDC) lblUSDC.innerHTML = 250;
      if (buttonConnect) buttonConnect.innerHTML = "Claim tokens";
